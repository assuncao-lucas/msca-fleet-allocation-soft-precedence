...
public:
	...
	virtual void Reset();
	static std::string GenerateFileName(bool solve_cutting_plane, bool add_symmetry_breaking, bool vehicle_sequencing_model, bool item_sequencing_model, bool vehicle_slots_model, bool reformulate, int ks_max_size_bucket, int ks_min_time_limit, int ks_max_time_limit, double ks_decay_factor);
